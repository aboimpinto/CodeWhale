...
//! stash, hooks, subagents, agent, links, feedback, home, workspace,
//! attach, task, jobs, mcp, network, rlm, profile

use crate::commands::{
    CommandResult, agent, anchor, attachment, core, feedback, hooks, jobs, mcp, network, provider,
    queue, rlm, stash, task,
};
